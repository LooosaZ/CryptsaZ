...
# TODO: TripleDES is deprecated and considered weak in modern contexts.
# Prefer AES (AES-128/256) or ChaCha20 for new projects. Keep TripleDES
# here only for backward compatibility with existing encrypted files.
